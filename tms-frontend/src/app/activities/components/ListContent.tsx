...
export const ListContent: React.FC<ListContentProps> = ({ }) => {
    ...
    const listActivity: IActivity[] = [{
        ...
        description: "Wake up early to do some exercise, Wake up early to do some exercise...max 2 lines and it'll be elipsis",
    ...
    },
    {
        id: 4,
        title: "Going Gym",
        description: "Wake up early to do some exercise, Wake up early to do some exercise...max 2 lines and it'll be elipsis Wake up early to do some exercise...max 2 lines and it'll be elipsis",
        dateTime: "08/12/2024 06:00 - 08/12/2024 07:00",
        categories: ["Passion"],
        status: 'on-progress'
    },
    ...
    return (
        <div className="flex flex-wrap gap-4">
            {listActivity.map((item, _index) => (<CardActivity key={item.id} title={item.title}
